...
public class ControlsOptions : MonoBehaviour
{
	...
	private void Start()
	{
		...
		wText.text = ((KeyCode)PlayerPrefs.GetInt("KeyW", 119)/*cast due to .constrained prefix*/).ToString();
		sText.text = ((KeyCode)PlayerPrefs.GetInt("KeyS", 115)/*cast due to .constrained prefix*/).ToString();
		aText.text = ((KeyCode)PlayerPrefs.GetInt("KeyA", 97)/*cast due to .constrained prefix*/).ToString();
		dText.text = ((KeyCode)PlayerPrefs.GetInt("KeyD", 100)/*cast due to .constrained prefix*/).ToString();
		jumpText.text = ((KeyCode)PlayerPrefs.GetInt("KeyJump", 32)/*cast due to .constrained prefix*/).ToString();
		dodgeText.text = ((KeyCode)PlayerPrefs.GetInt("KeyDodge", 304)/*cast due to .constrained prefix*/).ToString();
		slideText.text = ((KeyCode)PlayerPrefs.GetInt("KeySlide", 306)/*cast due to .constrained prefix*/).ToString();
		fire1Text.text = ((KeyCode)PlayerPrefs.GetInt("KeyFire1", 323)/*cast due to .constrained prefix*/).ToString();
		fire2Text.text = ((KeyCode)PlayerPrefs.GetInt("KeyFire2", 324)/*cast due to .constrained prefix*/).ToString();
		punchText.text = ((KeyCode)PlayerPrefs.GetInt("KeyPunch", 102)/*cast due to .constrained prefix*/).ToString();
		lastUsedWeaponText.text = ((KeyCode)PlayerPrefs.GetInt("KeyLastUsedWeapon", 113)/*cast due to .constrained prefix*/).ToString();
		changeVariation.text = ((KeyCode)PlayerPrefs.GetInt("KeyChangeVariation", 101)/*cast due to .constrained prefix*/).ToString();
		allTexts.Add(wText);
		allTexts.Add(sText);
		allTexts.Add(aText);
		allTexts.Add(dText);
	...
	public void ResetKeys()
	{
		...
		for (int i = 0; i < allTexts.Count; i++)
		{
			...
			allTexts[i].text = ((KeyCode)PlayerPrefs.GetInt("Key" + allTexts[i].transform.parent.name)/*cast due to .constrained prefix*/).ToString();
		}
	}
